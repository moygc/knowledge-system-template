...
See `AGENTS.md` for full repository instructions. This file exists only because Claude Code reads `CLAUDE.md` automatically. The non-negotiable rules below must remain an exact mirror of the corresponding rules in `AGENTS.md`.

## Non-negotiable rules (mirrored from AGENTS.md, keep both in sync if edited)
